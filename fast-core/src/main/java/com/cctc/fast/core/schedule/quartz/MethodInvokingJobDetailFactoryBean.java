package com.cctc.fast.core.schedule.quartz;
...
public class MethodInvokingJobDetailFactoryBean extends ArgumentConvertingMethodInvoker
	...
	public static class MethodInvokingJob extends QuartzJobBean {
		...
		protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
				...
				MethodInvokingJob methodInvokingJob = (com.cctc.fast.core.schedule.quartz.MethodInvokingJobDetailFactoryBean.MethodInvokingJob) context.getJobInstance();
				com.cctc.fast.core.schedule.quartz.MethodInvokingJobDetailFactoryBean methodInvokingJobDetailFactoryBean= (com.cctc.fast.core.schedule.quartz.MethodInvokingJobDetailFactoryBean)methodInvokingJob.methodInvoker;
				...
				String name = taskDefine.getSingalKey();
	    		...
	    		if(isOwner && isRunning){
	    			...
	    			try {
						ConsoleManager.getScheduleManager().getScheduleDataManager().saveRunningInfo(name, ConsoleManager.getScheduleManager().getScheduleServerUUid(), 0, msg);
					} catch (Exception e) {
